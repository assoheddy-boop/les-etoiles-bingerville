...
export const helpPages: HelpPage[] = [
  ...
  { path: "/cycles", title: "Cycles", blurb: "Maternelle, primaire, secondaire.", roles: ["all"] },
  ...
  { path: "/cycles/secondaire", title: "Secondaire", blurb: "Collège Les Étoiles (non ouvert).", roles: ["all"] },
